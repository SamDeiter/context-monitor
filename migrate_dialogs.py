"""
Phase 4 Migration - Extract UI Dialog Windows to dialogs.py

This approach uses factory functions that receive the monitor instance,
allowing dialogs to access monitor state without tight coupling.
"""
...
# Write the dialogs.py file
from pathlib import Path

dialogs_file = Path(r"C:\Users\Sam Deiter\Documents\GitHub\context-monitor\dialogs.py")
dialogs_file.write_text(dialogs_content, encoding='utf-8')
print(f"[✓] Created {dialogs_file.name}")

# Now update context_monitor.pyw to import and use these
print("\n[i] Next: Update context_monitor.pyw to use dialogs.py")
print("    - Add: from dialogs import show_history_dialog, show_diagnostics_dialog, show_advanced_stats_dialog")
print("    - Replace show_history -> show_history_dialog(self)")
print("    - Replace show_diagnostics -> show_diagnostics_dialog(self)")  
print("    - Replace show_advanced_stats -> show_advanced_stats_dialog(self)")
