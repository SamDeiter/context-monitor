...
// turbo
Read the referenced specification file completely before asking any questions.
...
1. Synthesize all answers into the spec file
2. Preserve the original structure where sensible
3. Add new sections for areas uncovered during interview
4. Mark any remaining open questions with `[TBD]`
5. Show the user the final spec for approval
